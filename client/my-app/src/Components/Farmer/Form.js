...
const SignupForm = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (Object.keys(errors).length > 0) {
            ...
            swal({title: "Form submitted !", text: "Your Data is stored successfully and it is safe", icon: "success", button: "OK"});
            // post request
    ...
    return (
        <form onSubmit={handleSubmit}>
            ...
            <span className="input-group">
                <input type="text" placeholder="Enter your first name ..." id="fname" name="fname" className="form-control"
                    value={
                        formData.fname
                    }
                    onChange={handleChange}/> {
                errors.fname && <span style={errorStyle}>
                    {
                    errors.fname
                }</span>
            } </span>
            ...
            <span className="input-group">
                <input type="text" placeholder="Enter your last name ..." id="lname" name="lname" className="form-control"
                    value={
                        formData.lname
                    }
                    onChange={handleChange}/> {
                errors.lname && <span style={errorStyle}>
                    {
                    errors.lname
                }</span>
            } </span>
            ...
            <div className="input-group">
                <input type="text" placeholder="Enter your age ..." id="age" name="age" className="form-control"
                    value={
                        formData.age
                    }
                    onChange={handleChange}/> {
                errors.age && <p style={errorStyle}>
                    {
                    errors.age
                }</p>
            } </div>
            ...
            <div className="input-group">
                <input type="text" placeholder="Enter your aadhar number ..." id="aadhar_no" name="aadhar_no" className="form-control"
                    value={
                        formData.aadhar_no
                    }
                    onChange={handleChange}/> {
                errors.aadhar_no && <p style={errorStyle}>
                    {
                    errors.aadhar_no
                }</p>
            } </div>
            ...
            <div className="input-group">
                <input type="text" placeholder="Enter your unique number ..." id="unique_id" name="unique_id" className="form-control"
                    value={
                        formData.unique_id
                    }
                    onChange={handleChange}/> {
                errors.unique_id && <p style={errorStyle}>
                    {
                    errors.unique_id
                }</p>
            } </div>
            ...
            <div className="input-group">
                <input type="text" placeholder="Enter your phone number ..." id="phone_no" name="phone_no" className="form-control"
                    value={
                        formData.phone_no
                    }
                    onChange={handleChange}/> {
                errors.phone_no && <p style={errorStyle}>
                    {
                    errors.phone_no
                }</p>
            } </div>
            ...
            <div className="input-group">
                <input type="text" placeholder="Enter your city ..." id="city" name="city" className="form-control"
                    value={
                        formData.city
                    }
                    onChange={handleChange}/> {
                errors.city && <p style={errorStyle}>
                    {
                    errors.city
                }</p>
            } </div>
            ...
            <div className="input-group">
                <input type="text" placeholder="Enter your state ..." id="state" name="state" className="form-control"
                    value={
                        formData.state
                    }
                    onChange={handleChange}/> {
                errors.state && <p style={errorStyle}>
                    {
                    errors.state
                }</p>
            } </div>
            ...
            <div className="input-group">
                <input type="text" placeholder="Enter your pincode ..." id="pincode" name="pincode" className="form-control"
                    value={
                        formData.pincode
                    }
                    onChange={handleChange}/> {
                errors.pincode && <p style={errorStyle}>
                    {
                    errors.pincode
                }</p>
            } </div>
            ...
            <div className="input-group">
                <input type={
                    ...
                    onChange={handleChange}/> {
                errors.password && <p style={errorStyle}>
                    {
                    errors.password
                }</p>
            } </div>
            ...
            <div className="input-group">
                <input type="password" placeholder="Confirm password ..." id="confirmPassword" name="confirmPassword" className="form-control"
                    value={
            ...
            <div>
                ...
                <button onClick={terms}>Click here</button>
            </div>
            <br/>
            <br/>
            <div>
                ...
                {
                errors.terms && <p style={errorStyle}>
                    {
                    errors.terms
                }</p>
            } </div>
            ...
            <div>
                ...
                <button className="login_a option-button"
                    onClick={FarmerLoginPage}>
                    Click Here
                </button>
            </div>
        </form>
